...
export default function PrimarySearchAppBar() {
    ...
    >
      <MenuItem onClick={handleProfileMenuOpen}>
        <IconButton
          ...
          color="inherit"
        >
          <IconButton size="large" edge="end" aria-label="account" onClick={handleProfileMenuOpen} color="inherit">
            <Avatar alt="User" src={userImage} /> {/* Using Avatar instead of AccountCircle */}
            </IconButton>
        </IconButton>
        <p>Profile</p>
      </MenuItem>
  ...
  <Typography variant="h6">Menu</Typography> {/* Replace icon with text */}
</IconButton>
          </IconButton>
